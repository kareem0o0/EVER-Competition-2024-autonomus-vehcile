...
file_path = '/home/daino/workspace/src/real_time/scripts/bag2_steering.csv'
...
def callvack(odom):
    ...
    for i in range (0, num_path_values):
        ...
        if distance >= 3.2 and distance <=3.5 and angle_diff>=0 and  angle_diff<=30: #tunable
            point =  path[i]
...
def calculate_curv(point):
   ...
   # Calculate relative position 
    ...
    cmd_pub.publish(4) #Tunable but not that important at first
'''
